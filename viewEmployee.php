       ...
       $param_addy = $_SESSION["shop_address"];
        ...
        if(mysqli_stmt_execute($stmt)){
			...
			echo "<td>$" . $row['salary'] . ".00</td>";
						echo "<td>";
						  echo "<a href='updateEmployee.php?employee_id=". $row['employee_id'] ."' title='Update Employee' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
