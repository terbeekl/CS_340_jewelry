...
<head>
    <meta charset="UTF-8">
    <title>View Customer Visit History</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <h2 class="pull-left">View Customer Visit History</h2>
                    </div>
<?php
    ...
    if($stmt = mysqli_prepare($link, $sql)){
       ...
       $param_addy = $_SESSION["shop_address"];
        ...
        if(mysqli_stmt_execute($stmt)){
			...
			echo "<h4> Customers Who Have Visited the Location on ". $param_addy ."</h4><p>";
